...
```javascript
// Basic Information
valentineName: "Indhu"                    // Your Valentine's name
pageTitle: "Will You Be My Valentine forever pattu ? 💝" // Browser tab title
...
questions: {
    first: {
        text: "Do you like me pattu ?",                   // First question
...
// Love Meter Messages
loveMessages: {
    extreme: "WOOOOW You love me that much chellakuttie ?? 🥰🚀💝",  // Shows above 5000%
...
celebration: {
    ...
    message: "Then will meet on 16th Monday and will spend a quality time chelame",          // Celebration message
